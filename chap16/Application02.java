package com.pangtaek.practice.chap16;
...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        String highestOrderCustomer = orders.stream()
                .max((o1, o2) -> Double.compare(o1.getTotalAmount(), o2.getTotalAmount())) // 가장 높은 금액의 주문 찾기
                .map(Order::getCustomerName) // 고객 이름 가져오기
                .orElse("No orders"); // 주문이 없을 경우 대체 값
